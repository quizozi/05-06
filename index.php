...
<body>
    ...
    <header class="intro-header" style="background-image: url('http://www.ecoticias.com/userfiles/extra/ZJZQ_fotonoticia_20160224193842_1280.jpg')">
        <div class="container">
            <div class="row">
                              ...
                              <h3><?php echo($a+1);?>. <?php echo $csv[$a]['titulo'];?></h3></a>
                                  <p><?php echo $csv[$a]['bajada'];?></p>
                                      <img src="<?php echo $csv[$a]['imagen'];?>" class="img-responsive">
                                          <h5><i><?php echo $csv[$a]['APA'];?> </i></h5>
                                            <p><strong>Tags:</strong> <?php echo $csv[$a]['tags'];?>.</p>
                                            <h6><i><a href= "<?php echo $csv[$a]['vinculo'];?>"> Texto completo</a></i></h6>
